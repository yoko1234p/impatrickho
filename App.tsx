  ...
  return (
    <div className={`min-h-screen relative transition-colors duration-500 font-sans ${isRecruiterMode ? 'bg-white text-gray-900' : 'bg-transparent text-gray-100'}`}>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-12 md:py-24">
        ...
        {/* FOOTER */}
        <footer className={`relative py-12 mt-12 ${isRecruiterMode ? 'border-t border-gray-200' : ''}`}>
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8 max-w-5xl mx-auto px-6">
            <div className="text-center md:text-left">
              ...
              <p className={`mt-2 text-sm ${isRecruiterMode ? 'text-gray-600' : 'text-gray-500'}`}>© {new Date().getFullYear()} Patrick Ho.</p>
            </div>
